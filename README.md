...
I put the rebuilt Flutter application inside `starter/`.

I completed the work in five parts:

1. I reviewed the supplied AI-generated screen.
   I recorded the real security, money, tenancy, and async problems in [REVIEW.md](starter/docs/REVIEW.md).
...
The detailed explanation is in [starter/docs/README.md](starter/docs/README.md).

---

## Important Files

- [Implementation and run guide](starter/docs/README.md)
- [My review findings](starter/docs/REVIEW.md)
- [API contract](API-CONTRACT.md)
- [Assignment](ASSIGNMENT.md)
- [Architecture decision](starter/docs/adr/0001-state-management-and-adaptive-layout.md)
- [AI usage disclosure](starter/docs/AI-USAGE.md)
